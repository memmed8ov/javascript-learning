...
export function Login() {
    ...
    return <><div style={{ background: 'grey', borderRadius: '50px', width: '400px', height: '400px', textAlign: 'center', margin: '50px' }}>
        <input type="text" placeholder='username' style={{ margin: '20px', borderRadius: '50px', height: "50px", textAlign: 'center', color: 'blue', borderColor: 'orange' }}value={text} onChange={e => setText((e.target.value))} />
        <br />
        ...
        <br />
        <div><input type="checkbox" style={{ width: '50px', height: '20px', }} value={checkbox} onChange={e => setCheckbox((e.target.value))}/>Remember me</div>
    </div>
        {/* <Routes>
